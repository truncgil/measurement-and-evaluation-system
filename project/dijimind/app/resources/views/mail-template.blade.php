...
if(!isset($to)) $to = "info@dijimind.com";
?>
                                ...
                                <tbody><tr>
                                  <td align="center" valign="top" class="textContent">
                                    <h1 style="color:#005c6a;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">
                                      <img src="https://app.dijimind.com/assets/dijimind-dikey.png" width="300" style="margin:20px auto;display:block" alt="Dijimind">
                                  </h1>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td valign="top" class="imageContent">
                                    <?php if(isset($img))  { 
                                      ?>
                                     <img src="{{$img}}" width="500" class="flexibleImage" style="max-width:500px;width:100%;display:block;" alt="Dijimind" title="Dijimind"> 
                                     <?php } ?>
                                  </td>
                                </tr>
                              </tbody></table>
                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tbody><tr>
                                  <td valign="top" bgcolor="#E1E1E1">
                                    ...
                                    <div>Copyright © {{date("Y")}}. Dijimind.</div>
                                      <div>Eğer bu tarz e-postaları almak istemiyorsanız. <a href="https://app.dijimind.com/unsubscribe?mail={{$to}}" target="_blank" style="text-decoration:underline;color:#828282;"><span style="color:#828282;">abonelikten çıkabilirsiniz</span></a>.</div>
                                    </div>
